				...
				if(record.get(3).equals(currentUser.getId())){
					...
					if (status.equals("Accepté")) {
						...
						ZonedDateTime time_debut = ZonedDateTime.of(Integer.parseInt(dateArr[2]),
								...
								dateFocus.getZone());
						calendarActivities.add(new CalendarActivity(time_debut,"Dep " + ville , 111111));
						calendarActivities.add(new CalendarActivity(time_debut, pays, 111111));
						...
						ZonedDateTime time_fin = ZonedDateTime.of(Integer.parseInt(dateArr[2]),
								Integer.parseInt(dateArr[1]), Integer.parseInt(dateArr[0]), 16, 0, 0, 0,
								dateFocus.getZone());
					calendarActivities.add(new CalendarActivity(time_fin,"Ret " + ville, 111111));
						calendarActivities.add(new CalendarActivity(time_fin, pays, 111111));
					}
				}
