...
public class TestController implements Initializable {
	...
	public void valideReservation(String numReservation) {
		String csvFile = "src/main/java/com/example/airbnb/views/reservation.csv";
		String line = "";
		String csvSplitBy = ",";
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		System.out.println("**********l'id de l'utilisteur est*****:  "+currentUser.getId());
		...
		for (CSVRecord record : csvParser) {
			if (i != 0) {
				...
				try {
					...
					nodes[i] = FXMLLoader.load(Objects.requireNonNull(HelloApplication.class.getResource("Item.fxml")));
				} catch (IOException e) {
					// TODO Auto-generated catch block
					e.printStackTrace();
				}
	...
	public void handleClicks(ActionEvent actionEvent) throws IOException {
		...
		if (actionEvent.getSource() == planing) {
			...
			// Chargez le fichier FXML de votre nouvelle fenêtre
			FXMLLoader loader = new FXMLLoader(HelloApplication.class.getResource("calendar.fxml"));
